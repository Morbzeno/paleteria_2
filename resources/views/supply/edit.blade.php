        ...
        <div class="col-md-10 col-lg-8">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('supply.update', $supply->supplier_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="description" class="form-control" value="{{old('description', $supply->description)}}"  required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Numero telefonico</label>
                                    <input type="text" name="phone_number" class="form-control" value="{{old('phone_number', $supply->phone_number)}}" required>
                                    @error('phone_number')
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input type="date" name="last_supply" class="form-control" value="{{old('last_supply', $supply->last_supply)}}"  required>
                                </div>
